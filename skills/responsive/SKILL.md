...
3. `${ARC_ROOT}/references/pretext.md` — If text-heavy layouts: reflow-free text measurement across breakpoints. Note: if font-size changes at a breakpoint, `prepare()` must be re-called with the new font string.
</required_reading>
